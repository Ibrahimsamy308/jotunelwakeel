        ...
        <div class="row">
            <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <a class="text-dark py-2 pe-3 border-end border-white" href=""><i class="bi bi-telephone text-secondary me-2"></i>+01289189890</a>
                    <a class="text-dark py-2 px-3" href=""><i class="bi bi-envelope text-secondary me-2"></i>ibrahimsamy308@gmail.com</a>
                </div>
            </div>
...
<!-- Navbar Start -->
<nav   style="background-color: #ffffff"  class="navbar navbar-expand-lg  navbar-dark shadow-sm px-5 py-3 py-lg-0" >
    <a href="{{ route('home') }}" class="navbar-brand p-0">
        <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-paint-roller text-secondary me-3"></i>El Wakeel</h1>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="d-none d-lg-flex align-items-center ps-4">
            ...
            <div>
                ...
                <h6  style="color:#ab9797"  {{--class="text-light m-0"--}} >+201289189890</h6>
            </div>
        </div>
    </div>
</nav>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>Moll EL Aasema, New Minya</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>ibrahimsamy308@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary me-3"></i>+2012 891 89890</p>
            </div>
            <div class="col-lg-3 col-md-6">
    ...
    <div class="container">
        <div class="row g-0">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">Copyright &copy; <a class="text-dark fw-bold" href="{{route('home')}}">JotunElwakeel</a>. All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-dark fw-bold" href="{{route('home')}}">Ibrahim Samy</a></p>
                <p><br>Distributed By: <a class="border-bottom" href="{{route('home')}}" target="_blank">Ibrahim Samy</a></p>
            </div>
        </div>
    </div>
</div>
