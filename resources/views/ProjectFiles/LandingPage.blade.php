        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div class="pt-2">
                        <a href="{{route('register')}}" class="btn btn-secondary rounded-pill py-md-3 px-md-5 mx-2">Sign Up</a>
                        <a href="{{route('login')}}" class="btn btn-outline-secondary rounded-pill py-md-3 px-md-5 mx-2">Login</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-0 mb-3 mb-lg-0">
                ...
                <div class="col-lg-6" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset('assets/img/about-1.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
            <div class="row gx-0">
                <div class="col-lg-6" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset('assets/img/about-2.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid p-1 bg-secondary" src="{{asset('assets/img/testimonial-1.jpg')}}" alt="">
                                <div class="ps-3">
                                    <h3>Client Name</h3>
                        ...
                        <div class="testimonial-item">
                            <p class="fs-4 fw-normal"><i class="fa fa-quote-left text-secondary me-3"></i>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid p-1 bg-secondary" src="{{asset('assets/img/testimonial-2.jpg')}}" alt="">
                                <div class="ps-3">
                                    <h3>Client Name</h3>
                                    <span class="text-uppercase">Profession</span>
                                </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="blog-item bg-primary">
                        ...
                        <div class="d-flex justify-content-between border-top border-secondary p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle me-2" src="{{asset('assets/img/user.jpg')}}" width="30" height="30" alt="">
